...
class VoterController extends Controller
{
    public function index()
    {
        ...
        return view("voter.index", [
            'title' => 'PEMIRA HMIF | Halaman Pemilihan',
    ...
    public function result()
    {
        ...
        if ($user->choice) {
            ...
            $countdown = Countdown::latest()->first(); // Ambil data countdown terbaru
            return view('countdown.index', [
                'title' => 'PEMIRA HMIF | Hasil Pemilihan Raya Mahasiswa Teknik Informatika',
